...
const api = require('@alpacahq/alpaca-trade-api/lib/api')
...
const calendar = require('@alpacahq/alpaca-trade-api/lib/resources/calendar')
const clock = require('@alpacahq/alpaca-trade-api/lib/resources/clock')
const asset = require('@alpacahq/alpaca-trade-api/lib/resources/asset')
const order = require('@alpacahq/alpaca-trade-api/lib/resources/order')
const data = require('@alpacahq/alpaca-trade-api/lib/resources/data')
const watchlist = require('@alpacahq/alpaca-trade-api/lib/resources/watchlist')
const polygon = require('@alpacahq/alpaca-trade-api/lib/resources/polygon')

const websockets = require('@alpacahq/alpaca-trade-api/lib/resources/websockets')
